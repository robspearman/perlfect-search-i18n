#!/usr/bin/perl -w
#$rcs = ' $Id: search.pl,v 1.101 2007/03/09 20:50:35 gzervas Exp $ ' ;
...
sub cast_template {
  ...
  # my $sidebar = new Perlfect::Sidebar();
  ...
  my $start_page = $current_page - 9;
  if ($start_page < 1) {
      $start_page = 1;
  }
  my $end_page   = $current_page + 9;
