#!/usr/bin/perl -w
# $rcs = ' $Id: setup.pl,v 1.31 2007/03/30 22:55:03 gzervas Exp $ ' ;    

# Perlfect Search - Setup Utility
#
# Copyright (C) 1999-2007 Giorgos Zervas <giorgos@perlfect.com> and 
...
#install_file("Perlfect/Sidebar.pm", $instdir."Perlfect/Sidebar.pm", "0644");
