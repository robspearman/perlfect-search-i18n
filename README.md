...
A lightweight and easy to set up freetext search system for websites, written in Perl
and updated with UTF-8 support.

Search strings and results now support any language via UTF-8 encoding.  Just make
sure that your web server is serving your content UTF-8 encoded.
...
Searching
   ...
   Searching is really simple: Type in one or more words into the search
