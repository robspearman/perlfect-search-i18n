#!/usr/bin/perl -w
#$rcs = ' $Id: indexer.pl,v 1.79 2003/06/26 23:54:00 daniel Exp $ ' ;
...
sub delete_temp_files {
  my @tmp_files = ($INV_INDEX_TMP_DB_FILE,$DOCS_TMP_DB_FILE,$URLS_TMP_DB_FILE,
    $SIZES_TMP_DB_FILE,$TERMS_TMP_DB_FILE,$DESC_TMP_DB_FILE,$TITLES_TMP_DB_FILE,
    $CONTENT_TMP_DB_FILE,$DATES_TMP_DB_FILE);
  if( $LOW_MEMORY_INDEX ) {
